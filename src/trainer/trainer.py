...
class Trainer:
    ...
    def __init__(self, train_config: dict, model_config: dict, run_config: dict):
        ...
        self.train_loader = DataLoader(
            ...
            batch_size=bs, shuffle=True,  collate_fn=collate_fn, pin_memory=True
        )
        self.dev_loader = DataLoader(
            ASVSpoofDataset(train_config['dev_dir'], train_config['dev_protocol'], 'dev'),
            batch_size=bs, shuffle=False, collate_fn=collate_fn, pin_memory=True
        )
...
if __name__ == '__main__':
    train_cfg = {
        ...
        'train_protocol':'data/raw/.../ASVspoof2019.LA.cm.train.trn.txt',
        'dev_dir':       'data/processed/dev',
        'dev_protocol':'data/raw/.../ASVspoof2019.LA.cm.dev.trl.txt',
        'eval_dir':      'data/processed/eval',
        'eval_protocol':'data/raw/.../ASVspoof2019.LA.cm.eval.trl.txt',
        'batch_size':     16
    }
    model_cfg = {
